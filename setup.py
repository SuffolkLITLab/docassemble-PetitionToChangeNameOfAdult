...
setup(name='docassemble.PetitionToChangeNameOfAdult',
      ...
      install_requires=['docassemble.ALAffidavitOfIndigency>=2.0.3',
          'docassemble.CARIRequest @ https://github.com/SuffolkLITLab/docassemble-CARIRequest/archive/main.zip'],
      zip_safe=False,
